	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				...
				<c:if test="${sessionScope.email != null}"><a href="./myreservation?reservationEmail=${email }" class="btn_my"> <span title="내예약" class="viewReservation">${email}</span> </a></c:if>
			</header>
		</div>
		<hr>
		<div class="ct">
								...
								<article class="card_item">
									<a class="link_booking_details">
										<div class="card_body">
											...
											<div class="middle">
												<div class="card_detail">
													<em class="booking_number">No.99999999</em>
													<h4 class="tit">리뷰 기능 확인 공간</h4>
													<ul class="detail">
														<li class="item">
															<span class="item_tit">예약</span>
															<em class="item_dsc">
													...
													<div class="booking_cancel">
														<a href="/reviewWrite?reservationEmail=${email }"><button class="btn"><span>예매자 리뷰 남기기</span></button></a>
													</div>
												</div>
											</div>
											<div class="right"></div>
		...
		<!--// 취소 팝업 -->
		<script type="template" id="confirmCard">
			<article class="card_item">
				<a class="link_booking_details">
					<div class="card_body">
						<div class="left"></div>
		...
		<script type="template" id="usedCard">
		
		</script>
		<script type="template" id="cancelCard">
			<article class="card_item">
				<a class="link_booking_details">
					<div class="card_body">
						<div class="left"></div>
		...
		<script type="template" id="noList">
		<!-- 예약 리스트 없음 -->
