...
<body>
            ...
            <div class="ct_wrap">
                ...
                <div class="group_visual">
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img"><!-- https://ssl.phinf.net/naverbooking/20170217_264/1487312141947lTddT_JPEG/%B3%D7%C0%CC%B9%F6.jpg?type=ff1242_816 -->
                            <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="" style ="height: 414px"> <span class="img_bg"></span>
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        <h3 class="in_tit"></h3>
                        <p class="dsc" style="margin-bottom: 0px"></p> 
                        <p class="dsc">기간 : 2017.2.17.(금)~2017.4.18.(화)</p>
                ...
                <div class="section_booking_form">
                        ...
                        <div class="form_wrap">
                            ...
                            <form class="form_horizontal">
                                <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
                                    <div class="inline_control"> <input type="text" name="name" id="name" class="text" placeholder="네이버" maxlength="25"> </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                                    <div class="inline_control tel_wrap">
                                        <input type="tel" name="tel" id="tel" class="tel" value="" placeholder="하이픈 포함 번호를 입력해 주세요">
                                    </div>
                                </div>
                    ...
                    <div class="section_booking_agreement">
                        ...
                        <div class="agreement part"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span> </span>
                            <a id ="expand1" class="btn_agreement"> <span class="btn_text">보기</span> <i class="fn fn-down2"></i> </a>
                        ...
                        <!-- [D] 약관 보기 클릭 시 agreement에 open 클래스 추가 -->
                        <div class="agreement part"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 제3자 제공 동의</span> </span>
                            <a id = "expand2" class="btn_agreement"> <span class="btn_text">보기</span> <i class="fn fn-down2"></i> </a>
                ...
                <div class="box_bk_btn">
                    ...
                    <div class="bk_btn_wrap disable"> <button type="button" class="bk_btn" disabled> <i class="spr_book ico_naver_s"></i>  <span id="reserve">예약하기</span> </button> </div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="template" id="inIntroTemplate">
		<div class="qty">
		    <div id = "countId" class="count_control">
		    ...
		    <div class="qty_info_icon"> <strong class="product_amount"> <span>{{type}}</span> </strong> <strong class="product_price"> <span class="price">{{regExpPrice}}</span> <span class="price_type">원</span> </strong> <em class="product_dsc">{{regExpPrice}}원 ({{discountRate}}% 할인가)</em> </div>
		</div>
	</script>
